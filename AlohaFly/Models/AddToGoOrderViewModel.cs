...
namespace AlohaFly.Models
{
    ...
    class AddToGoOrderViewModel : ViewModelPaneReactiveObject
    {
        ...
        /*
        public OrderCustomer SelectedOrderCustomer
        {
            get
            {
                return model.Order.OrderCustomer;
            }
            set
            {
                model.Order.OrderCustomer = value;
                if (model.Order.OrderCustomer != null)
                {
                    if (model.Order.OrderCustomer.PrimaryAddress != null)
                    {
                        model.SelectedContactPersonAddressId = model.Order.OrderCustomer.PrimaryAddress.Id;
                        SelectedOrderCustomerAddress = model.Order.OrderCustomer.PrimaryAddress.Address;
                    }
                }

                this.RaisePropertyChanged("SelectedOrderCustomer");
                this.RaisePropertyChanged("SelectedOrderCustomerAddress");
            }
        }

        public string SelectedOrderCustomerName
        {
            set
            {
        ...
        public string SelectedOrderCustomerEmail
        {
            set
            {
        ...
        public string SelectedOrderCustomerPhone
        {
            set
            {
        ...
        public string SelectedOrderCustomerAddress
        {

            set
            {
                model.SelectedContactPersonAddress = value;
            }
            get
            {
                return model.SelectedContactPersonAddress;
            }
        }

        public string SelectedOrderCustomerComment
        {
            set
            {
                model.SelectedContactPersonComment = value;
                //model.Order.OrderCustomer.Comments=value;
            }
            get
            {
                return model.SelectedContactPersonComment;
                //return model.Order.OrderCustomer.Comments;
            }
        }
        
        public FullyObservableCollection<OrderCustomer> OrderCustomerCatalog
        {
            get
            {
                return DataCatalogsSingleton.Instance.ToGoCustomers;
            }
        }
        */
