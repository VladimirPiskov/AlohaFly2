...
namespace AlohaService.ExcelExport
{
    public static class ExportHelper
    {
        ...
        /*
        public static Workbook ExportToExcelWorkbookEnglish(ServiceDataContracts.OrderFlight order)
        {
            ...
            worksheet.Cells[rowIndex, colIndex].SetUnderline(UnderlineType.Single);
            worksheet.Columns[colIndex].SetWidth(new ColumnWidth(120, false));
            worksheet.Cells[rowIndex, colIndex++].SetValue(String.Format("{0}, {1}, {2}, {3}, {4}, {5}",
                order.DeliveryPlace.Name,
                order.FlightNumber,
                order.DeliveryDate.ToString("dd.MM.yyyy"),
                order.OrderTotalSumm.ToString("C", CultureInfo.CreateSpecificCulture("ru-RU")),
            ...
            worksheet.Cells[rowIndex, colIndex].SetBorders(new CellBorders(border1, border1, border1, border1, null, null, null, null));
            worksheet.Columns[colIndex].SetWidth(new ColumnWidth(50, false));
            worksheet.Cells[rowIndex-1, colIndex].SetFontSize(10.5);
            worksheet.Cells[rowIndex-1, colIndex].SetFontFamily(new ThemableFontFamily("Arial"));
            ...
            foreach (var package in order.DishPackages)
            {
                number++;
                colIndex = 1;
                rowIndex++;
